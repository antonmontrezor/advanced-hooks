...
A nice way to utilize capabilities of useCallback is to return a function wrapped in useCallback to whatever and call it passing args (using that args in a function)
line 24
