...
React context could be used if that's the UI library or we have truly global data like theme or language settings or user preferences

<CountContext.Provider value={value} {...props} /> is identical <CountContext.Provider value={value} >{children}</CountContext.Provider>
